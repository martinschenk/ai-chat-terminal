...
# 3. Delete everything in .aichat (user installation ONLY!)
echo "3️⃣ Deleting ~/.aichat (including .env, config, db)..."
rm -rf ~/.aichat
echo "   ✅ Deleted"

# 4. Install fresh from GitHub via curl (like a NORMAL USER!)
echo "4️⃣ Installing from GitHub via curl (user installation)..."
